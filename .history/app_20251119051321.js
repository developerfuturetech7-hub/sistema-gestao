...
class SistemaGestao {
    ...
    init() {
        ...
        setTimeout(() => {
            ...
            // Forçar valor a cada 500ms para garantir que não suma
            setInterval(() => {
                const campo = document.getElementById('saldoInicial');
                if (campo && this.dados.saldoInicial && (!campo.value || campo.value === '0' || campo.value === '0.00')) {
                    campo.value = this.dados.saldoInicial;
                    console.log('Restaurando saldo automaticamente:', this.dados.saldoInicial);
                }
            }, 500);
        }, 100);
    }
